define(["app", "config/storage/localstorage"], function(LightningAbstracts){
  LightningAbstracts.module('Entities', function(Entities, LightningAbstracts, Backbone, Marionette, $, _){
    ...
    LightningAbstracts.reqres.setHandler("contact:entities", function(){
      return API.getContactEntities();
    });

    LightningAbstracts.reqres.setHandler("contact:entity", function(id){
      return API.getContactEntity(id);
    });

    LightningAbstracts.reqres.setHandler("contact:entity:new", function(id){
