...
<form class="new-journal" enctype="multipart/form-data">
  ...
  <div class="close"></div>
  <div class="login formTitle">EDIT INDICATOR:</div>
  <div class="login journalData">
    ...
    <div class="labForm-group">
      ...
      <select id="lab-acategory" class="lab-input" value="<%= period %>" name="period">
        ...
        <div  id="img-cont" class="img-container">
          <ul>
            <li class="bg-img">
              <figure>
                <img src=".<%= logo_url %>">
                <figcaption id="jcover-img"><%= min_logo_url %></figcaption>
              </figure>
            </li>
          </ul>
