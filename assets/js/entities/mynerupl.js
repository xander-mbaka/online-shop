define(["app"], function(RealEstate){
  RealEstate.module('Entities', function(Entities, RealEstate, Backbone, Marionette, $, _){
    ...
    Entities.Property = Backbone.Model.extend({
      urlRoot: "presentation/property",
    });

    Entities.PropertyCollection = Backbone.Collection.extend({
      url: "/presentation/properties",
    ...
    var API = {
      ...
      getBlogEntities: function(){
        ...
        $.when(
          ...
          $.get("/presentation/blogs", function(val){
      ...
      getPropertyEntities: function(page){
        ...
        $.when(
          ...
          $.get("/presentation/properties/?properties=1&page=" + page, function(val){
      ...
      getTotalEntities: function(){
        ...
        $.when(
          ...
          $.get("/presentation/properties/?allcount", function(val){
      ...
      getFeaturedEntities: function(){
        ...
        $.when(
          ...
          $.post("/presentation/properties/index.php", data, function(val){
            var models = initializeProperties(JSON.parse(val));
            properties.reset(models);       
          })
      ...
      getBlog: function(model){
        ...
        $.when(
          ...
          $.get("/presentation/blogs/?blogId=" + blogId, function(full){
            fullBlog = full;       
          }),

          $.get("/presentation/blogs/?comments=" + blogId, function(res){
